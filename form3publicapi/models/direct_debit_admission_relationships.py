...
class DirectDebitAdmissionRelationships(object):

    """Implementation of the 'DirectDebitAdmissionRelationships' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitAdmissionRelationships class"""
