...
from form3publicapi.models.signing_keys_attributes import SigningKeysAttributes


class SigningKeysResponseData(object):

    """Implementation of the 'SigningKeysResponseData' model.

    TODO: type model description here.

    Attributes:
        attributes (SigningKeysAttributes): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the SigningKeysResponseData class"""
    ...
    def from_dictionary(cls,
        ...
        attributes = SigningKeysAttributes.from_dictionary(dictionary.get('attributes')) if dictionary.get('attributes') else None
