...
class DirectDebitReturnCreationResponse(object):

    """Implementation of the 'DirectDebitReturnCreationResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitReturnCreationResponse class"""
