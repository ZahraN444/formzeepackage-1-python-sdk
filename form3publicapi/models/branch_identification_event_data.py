...
from form3publicapi.models.branch_identification_attributes import BranchIdentificationAttributes
from form3publicapi.models.branch_identification_event_relationships import BranchIdentificationEventRelationships


class BranchIdentificationEventData(object):

    """Implementation of the 'BranchIdentificationEventData' model.

    TODO: type model description here.

    Attributes:
        attributes (BranchIdentificationAttributes): TODO: type description
            here.
        ...
        mtype (str): Type of this resource, always branch_identifications
        version (int): Version number
        relationships (BranchIdentificationEventRelationships): TODO: type
            description here.
    ...
    def __init__(self,
        ...
        """Constructor for the BranchIdentificationEventData class"""
    ...
    def from_dictionary(cls,
        ...
        attributes = BranchIdentificationAttributes.from_dictionary(dictionary.get('attributes')) if dictionary.get('attributes') else None
        ...
        relationships = BranchIdentificationEventRelationships.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
