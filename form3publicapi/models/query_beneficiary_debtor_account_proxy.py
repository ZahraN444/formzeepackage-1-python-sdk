...
class QueryBeneficiaryDebtorAccountProxy(object):

    """Implementation of the 'QueryBeneficiaryDebtorAccountProxy' model.
    ...
    def __init__(self,
        ...
        """Constructor for the QueryBeneficiaryDebtorAccountProxy class"""
