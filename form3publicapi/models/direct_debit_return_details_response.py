...
class DirectDebitReturnDetailsResponse(object):

    """Implementation of the 'DirectDebitReturnDetailsResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitReturnDetailsResponse class"""
