...
class MandateAdmissionRelationships(object):

    """Implementation of the 'MandateAdmissionRelationships' model.
    ...
    def __init__(self,
        ...
        """Constructor for the MandateAdmissionRelationships class"""
