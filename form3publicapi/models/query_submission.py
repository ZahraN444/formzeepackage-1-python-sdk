...
from form3publicapi.models.query_submission_attributes import QuerySubmissionAttributes
from form3publicapi.models.query_submission_relationships import QuerySubmissionRelationships


class QuerySubmission(object):

    """Implementation of the 'QuerySubmission' model.

    TODO: type model description here.

    Attributes:
        attributes (QuerySubmissionAttributes): TODO: type description here.
        ...
        relationships (QuerySubmissionRelationships): TODO: type description
            here.
    ...
    def __init__(self,
        ...
        """Constructor for the QuerySubmission class"""
    ...
    def from_dictionary(cls,
        ...
        attributes = QuerySubmissionAttributes.from_dictionary(dictionary.get('attributes')) if dictionary.get('attributes') else None
        ...
        relationships = QuerySubmissionRelationships.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
