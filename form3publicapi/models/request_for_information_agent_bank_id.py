...
class RequestForInformationAgentBankId(object):

    """Implementation of the 'RequestForInformationAgentBankId' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RequestForInformationAgentBankId class"""
