...
class ReceiversCorrespondentAccountHoldingEntity(object):

    """Implementation of the 'ReceiversCorrespondentAccountHoldingEntity' model.

    TODO: type model description here.

    Attributes:
        bank_address (List[str]): Receiver's correspondent's address
        bank_id (str): SWIFT BIC for receiver's correspondent
        ...
        bank_name (str): Receiver's correspondent's name
        bank_party_id (str): Receiver's correspondent party identifier
    ...
    def __init__(self,
        ...
        """Constructor for the ReceiversCorrespondentAccountHoldingEntity class"""
