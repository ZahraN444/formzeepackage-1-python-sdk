...
class QueryBeneficiaryDebtorOrganisationIdentification(object):

    """Implementation of the 'QueryBeneficiaryDebtorOrganisationIdentification' model.
    ...
    def __init__(self,
        ...
        """Constructor for the QueryBeneficiaryDebtorOrganisationIdentification class"""
