...
from form3publicapi.models.relationships_11 import Relationships11


class DirectDebitReturnReversal(object):

    """Implementation of the 'DirectDebitReturnReversal' model.
    ...
    Attributes:
        ...
        relationships (Relationships11): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitReturnReversal class"""
    ...
    def from_dictionary(cls,
        ...
        relationships = Relationships11.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
