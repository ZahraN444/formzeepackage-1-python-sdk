...
class RecallDecisionAdmissionRelationships(object):

    """Implementation of the 'RecallDecisionAdmissionRelationships' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecallDecisionAdmissionRelationships class"""
