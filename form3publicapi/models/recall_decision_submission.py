...
from form3publicapi.models.recall_decision_submission_relationships import RecallDecisionSubmissionRelationships


class RecallDecisionSubmission(object):

    """Implementation of the 'RecallDecisionSubmission' model.
    ...
    Attributes:
        ...
        relationships (RecallDecisionSubmissionRelationships): TODO: type
            description here.
    ...
    def __init__(self,
        ...
        """Constructor for the RecallDecisionSubmission class"""
    ...
    def from_dictionary(cls,
        ...
        relationships = RecallDecisionSubmissionRelationships.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
