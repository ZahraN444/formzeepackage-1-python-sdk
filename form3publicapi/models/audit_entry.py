...
from form3publicapi.models.attributes_18 import Attributes18


class AuditEntry(object):

    """Implementation of the 'AuditEntry' model.

    TODO: type model description here.

    Attributes:
        attributes (Attributes18): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the AuditEntry class"""
    ...
    def from_dictionary(cls,
        ...
        attributes = Attributes18.from_dictionary(dictionary.get('attributes')) if 'attributes' in dictionary.keys() else APIHelper.SKIP
