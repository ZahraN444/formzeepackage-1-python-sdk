...
class IntermediaryBankAccountHoldingEntity(object):

    """Implementation of the 'IntermediaryBankAccountHoldingEntity' model.
    ...
    def __init__(self,
        ...
        """Constructor for the IntermediaryBankAccountHoldingEntity class"""
