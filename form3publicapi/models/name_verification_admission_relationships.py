...
class NameVerificationAdmissionRelationships(object):

    """Implementation of the 'NameVerificationAdmissionRelationships' model.
    ...
    def __init__(self,
        ...
        """Constructor for the NameVerificationAdmissionRelationships class"""
