...
class ReimbursementAccountHoldingEntity(object):

    """Implementation of the 'ReimbursementAccountHoldingEntity' model.

    TODO: type model description here.

    Attributes:
        bank_address (List[str]): Third party reimbursement institution
            address
        bank_id (str): Identification of third party reimbursement
            institution
        ...
        bank_name (str): Third party reimbursement institution name
        bank_party_id (str): Third party reimbursement institution identifier
    ...
    def __init__(self,
        ...
        """Constructor for the ReimbursementAccountHoldingEntity class"""
