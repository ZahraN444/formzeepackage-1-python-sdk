...
class ReturnAdmissionFetchRelationships(object):

    """Implementation of the 'ReturnAdmissionFetchRelationships' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ReturnAdmissionFetchRelationships class"""
