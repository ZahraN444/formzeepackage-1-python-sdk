...
from form3publicapi.models.query_response_relationships import QueryResponseRelationships


class QueryResponse(object):

    """Implementation of the 'QueryResponse' model.
    ...
    Attributes:
        ...
        relationships (QueryResponseRelationships): TODO: type description
            here.
    ...
    def __init__(self,
        ...
        """Constructor for the QueryResponse class"""
    ...
    def from_dictionary(cls,
        ...
        relationships = QueryResponseRelationships.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
