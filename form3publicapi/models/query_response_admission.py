...
from form3publicapi.models.query_response_admission_attributes import QueryResponseAdmissionAttributes
from form3publicapi.models.query_response_admission_relationships import QueryResponseAdmissionRelationships


class QueryResponseAdmission(object):

    """Implementation of the 'QueryResponseAdmission' model.

    TODO: type model description here.

    Attributes:
        attributes (QueryResponseAdmissionAttributes): TODO: type description
            here.
        ...
        relationships (QueryResponseAdmissionRelationships): TODO: type
            description here.
    ...
    def __init__(self,
        ...
        """Constructor for the QueryResponseAdmission class"""
        ...
        self.mtype = 'query_response_admissions' 
    ...
    def from_dictionary(cls,
        ...
        attributes = QueryResponseAdmissionAttributes.from_dictionary(dictionary.get('attributes')) if dictionary.get('attributes') else None
        ...
        relationships = QueryResponseAdmissionRelationships.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
