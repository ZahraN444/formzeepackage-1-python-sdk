...
from form3publicapi.models.name_verification_submission_attributes import NameVerificationSubmissionAttributes
from form3publicapi.models.name_verification_submission_relationships import NameVerificationSubmissionRelationships


class NameVerificationSubmission(object):

    """Implementation of the 'NameVerificationSubmission' model.

    TODO: type model description here.

    Attributes:
        attributes (NameVerificationSubmissionAttributes): TODO: type
            description here.
        ...
        relationships (NameVerificationSubmissionRelationships): TODO: type
            description here.
    ...
    def __init__(self,
        ...
        """Constructor for the NameVerificationSubmission class"""
    ...
    def from_dictionary(cls,
        ...
        attributes = NameVerificationSubmissionAttributes.from_dictionary(dictionary.get('attributes')) if 'attributes' in dictionary.keys() else APIHelper.SKIP
        ...
        relationships = NameVerificationSubmissionRelationships.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
