...
class RecallSubmissionRelationships(object):

    """Implementation of the 'RecallSubmissionRelationships' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecallSubmissionRelationships class"""
