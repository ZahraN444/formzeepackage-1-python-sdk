...
class UltimateEntity(object):

    """Implementation of the 'UltimateEntity' model.
    ...
    Attributes:
        ...
        address (List[str]): Ultimate debtor/beneficiary address
        ...
        country_of_residence (str): Country of residence of the ultimate
            beneficiary, ISO 3166 format country code
    ...
    def __init__(self,
        ...
        """Constructor for the UltimateEntity class"""
