...
class AccountIdentificationEventRelationships(object):

    """Implementation of the 'AccountIdentificationEventRelationships' model.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountIdentificationEventRelationships class"""
