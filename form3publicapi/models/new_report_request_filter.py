...
from form3publicapi.models.new_report_request_report_user import NewReportRequestReportUser


class NewReportRequestFilter(object):

    """Implementation of the 'NewReportRequestFilter' model.
    ...
    Attributes:
        ...
        report_users (List[NewReportRequestReportUser]): TODO: type
            description here.
    ...
    def __init__(self,
        ...
        """Constructor for the NewReportRequestFilter class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('report_users') is not None:
            report_users = [NewReportRequestReportUser.from_dictionary(x) for x in dictionary.get('report_users')]
