...
class DirectDebitReversalDetailsResponse(object):

    """Implementation of the 'DirectDebitReversalDetailsResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitReversalDetailsResponse class"""
