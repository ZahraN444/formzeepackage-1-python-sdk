...
class Attributes58(object):

    """Implementation of the 'Attributes58' model.

    TODO: type model description here.

    Attributes:
        admission_datetime (datetime): Date and time the recall decision
            admission was created
        source_gateway (str): TODO: type description here.
        status (RecallDecisionAdmissionStatusEnum):
            [Status](http://draft-api-docs.form3.tech/api.html#enumerations-pay
            ment-admission-status) of the admission
        status_reason (str): Human-readable reason for failure if status is
            failed.
    ...
    def __init__(self,
        ...
        """Constructor for the Attributes58 class"""
