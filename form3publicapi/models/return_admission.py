...
from form3publicapi.models.return_admission_relationships import ReturnAdmissionRelationships


class ReturnAdmission(object):

    """Implementation of the 'ReturnAdmission' model.
    ...
    Attributes:
        ...
        relationships (ReturnAdmissionRelationships): TODO: type description
            here.
    ...
    def __init__(self,
        ...
        """Constructor for the ReturnAdmission class"""
    ...
    def from_dictionary(cls,
        ...
        relationships = ReturnAdmissionRelationships.from_dictionary(dictionary.get('relationships')) if 'relationships' in dictionary.keys() else APIHelper.SKIP
