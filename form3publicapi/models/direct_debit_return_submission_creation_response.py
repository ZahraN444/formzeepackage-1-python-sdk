...
class DirectDebitReturnSubmissionCreationResponse(object):

    """Implementation of the 'DirectDebitReturnSubmissionCreationResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitReturnSubmissionCreationResponse class"""
