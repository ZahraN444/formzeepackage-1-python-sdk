...
class Attributes17(object):

    """Implementation of the 'Attributes17' model.

    TODO: type model description here.

    Attributes:
        assignee (PaymentSubmissionTaskAssigneeEnum): Helps to identify the
            owner of the task
        name (str): Identifies the payment submission task to be executed
        output (Dict[str, object]): Key Value map that contains the Task
            result.
        status (PaymentSubmissionTaskStatusEnum): status of the submission
            task
    ...
    def __init__(self,
        ...
        """Constructor for the Attributes17 class"""
