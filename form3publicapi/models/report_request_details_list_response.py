...
class ReportRequestDetailsListResponse(object):

    """Implementation of the 'ReportRequestDetailsListResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ReportRequestDetailsListResponse class"""
