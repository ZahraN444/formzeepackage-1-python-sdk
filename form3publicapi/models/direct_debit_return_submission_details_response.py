...
class DirectDebitReturnSubmissionDetailsResponse(object):

    """Implementation of the 'DirectDebitReturnSubmissionDetailsResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitReturnSubmissionDetailsResponse class"""
