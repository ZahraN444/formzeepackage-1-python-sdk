...
class ClaimReversalSubmissionDetailsResponse(object):

    """Implementation of the 'ClaimReversalSubmissionDetailsResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ClaimReversalSubmissionDetailsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = ClaimReversalSubmission.from_dictionary(dictionary.get('data')) if 'data' in dictionary.keys() else APIHelper.SKIP
